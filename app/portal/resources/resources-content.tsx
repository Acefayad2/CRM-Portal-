...
const resourceLibrary: ResourceItem[] = [
  ...
  { id: "compliance-2", title: "Privacy Policy", description: "Current privacy terms for platform data handling, customer information, and service usage.", type: "document", category: "compliance", size: "Web page", date: "2026-03-11", icon: FileText, href: "/privacy-policy", actionLabel: "View policy" },
